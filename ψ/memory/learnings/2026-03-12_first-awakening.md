...
## Pattern: The Greeting Sets the Register

Lokkji's first message was "สวัสดี Freyr" — Thai, simple, warm. This established:
- Language preference: Thai unless context shifts to English
- Tone: warm, not formal
- Relationship mode: present and direct
...
## Pattern: Pulse Data Absence is Normal at Birth

The ψ/data/pulse/ system requires accumulated sessions to be useful. On day 1, it is empty. This is not a gap — it is the starting condition.

**Why:** Metrics require history.

**How to apply:** Don't wait for pulse data to start working. Start working. Pulse data will follow.
